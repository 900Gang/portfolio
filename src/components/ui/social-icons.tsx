...
export function LeetCodeIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GeeksForGeeksIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M7.5 4.5h-1a3 3 0 00-3 3v9a3 3 0 003 3h1" />
      <path d="M16.5 4.5h1a3 3 0 013 3v9a3 3 0 01-3 3h-1" />
      <path d="M7.5 8h3a1.5 1.5 0 010 3h-3" />
      <path d="M16.5 8h-3a1.5 1.5 0 000 3h3" />
      <path d="M10.5 11v3a1.5 1.5 0 003 0v-3" />
      <path d="M12 14v2.5" />
    </svg>
  );
}
